---
name: sharia-screen
description: "AI Berkshire skill: Sharia Compliance Screening — فحص التوافق الشرعي. Source: skills/sharia-screen.md."
---

## Codex adapter note

This skill is generated from `skills/sharia-screen.md` so Claude Code and Codex users share one canonical workflow.
