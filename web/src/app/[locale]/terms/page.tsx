    ...
    <>
      ...
      <main className="pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-mizan-gold/10 border border-mizan-gold/30 rounded-xl p-6 mb-8">
            <p className={`text-mizan-ink text-sm leading-relaxed ${locale === "ar" ? "font-arabic" : "font-latin"}`}>
              {t.intro}
            </p>
          </div>
